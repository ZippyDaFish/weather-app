async function getWeatherData(location, unit){
    const response = await fetch('https://cors-anywhere.herokuapp.com/api.openweathermap.org/data/2.5/weather?q='+location+'&units='+unit+'&APPID=1bc93ee0ee0d4cdd8fd91c4abca090f2', {mode: 'cors'});
...
async function getForecastData(location, unit){
    const response = await fetch('https://cors-anywhere.herokuapp.com/api.openweathermap.org/data/2.5/forecast?q='+location+'&units='+unit+'&APPID=1bc93ee0ee0d4cdd8fd91c4abca090f2', {mode: 'cors'});
